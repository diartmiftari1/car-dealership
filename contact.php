            ...
            <ul class="contact_info">
                <li>
                    ...
                    <div class="contact_side">
                        <h3>Adress</h3>
                        <a href="https://goo.gl/maps/fk35kuR2UmJ48J897">4516 Horizon Circle, Kosovo</a></li>
                    
                <li>
                    <i class="fa-solid fa-phone"></i>
                    <div class="contact_side">
                    <h3>Phone Number</h3>
                    <a href="tel:+38344123456">+38344123456</a></li>
                    
                <li>
                    <i class="fa-solid fa-envelope"></i>
                    <div class="contact_side">
                        <h3>Email</h3>
                        <a href="mailto:example@gmail.com">example@gmail.com</a></li>
                ...
                <li>
                    ...
                    <div class="contact_side">
                    <h3>Instagram</h3>
                    <a href="https://Instagram.com">Brand Name Goes Here</a></li>
            </ul>
